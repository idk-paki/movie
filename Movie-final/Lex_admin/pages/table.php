  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../pages/video_list.html">
		...
		<li class="nav-item">
		 ...
		 <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-dark font-weight-bolder opacity-5">Sit pages</h6>
        </li>
		<li class="nav-item">
          <a class="nav-link text-dark" href="../pages/sit_manage.php">
            <i class="material-symbols-rounded opacity-5">receipt_long</i>
            <span class="nav-link-text ms-1">Sit Manage</span>
          </a>
        </li>
        <?php 
			if($admin_id=='1')
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="javascript:;" style="" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                      </td>
                    </tr>
