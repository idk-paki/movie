        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-success font-weight-bolder">+15% </span>than yesterday</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-success font-weight-bolder">+3% </span>than yesterday</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
				  ...
				  <?php
					...
					$result = mysqli_query($connect,"SELECT * from purchased Order BY purchased_time DESC");
				  ...
				  <tr>
                     <td style="color:black;text-align:center;text-center;">
					  ...
					  <td style="color:black;text-align:center;text-center;">
						...
						$result2 = mysqli_query($connect,"SELECT * from user WHERE user_id='$user_id'");
					  ...
					  <td style="color:black;text-align:center;text-center;">
                        <a style="color:black;text-align:center;text-center;font-size: 12px;" href="http://localhost/Lex_movie/Lex_admin/pages/makepdf.php?pdf&id=<?php echo $row['user_id'];?>&purid=<?php echo $row['purchased_id'];?> ">
							Download </a>
                      </td>
