...
<body>
    <div class="receipt-content">
        <div class="invoice-wrapper">
            ...
            <br><br><br>
            <strong>Copyright © 2025 LEX MOVIE</strong>
        </div>
    </div>
	<div style="text-align: center; margin-top: 20px;">
        <a class="button" href="converttopdf.php?pdf&id=<?php echo $user_id; ?>&purid=<?php echo $purchased_id; ?>" name="Download">Download PDF</a>
        <a class="button" style="margin-left: 40px;" href="dashboard.php" name="Download">Main Menu</a>
    </div>
</body>
</html>